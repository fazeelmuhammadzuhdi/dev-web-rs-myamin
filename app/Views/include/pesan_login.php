...
if (session()->getFlashdata('success')) { ?>
    <div class="ui-pnotify ui-pnotify-fade-normal ui-pnotify-mobile-able ui-pnotify-in ui-pnotify-fade-in ui-pnotify-move" aria-live="assertive" aria-role="alertdialog" style="display: none; width: 300px; position: fixed; left: 50%; top: 15%; transform: translate(-50%, -50%); cursor: auto;">
...
if (session()->getFlashdata('error')) { ?>
    <div id="alertError" class="ui-pnotify ui-pnotify-fade-normal ui-pnotify-mobile-able ui-pnotify-in ui-pnotify-fade-in ui-pnotify-move" aria-live="assertive" aria-role="alertdialog" style="display: none; width: 300px; position: fixed; left: 50%; top: 15%; transform: translate(-50%, -50%); cursor: auto;">
        <div id="alertDanger" class="brighttheme ui-pnotify-container brighttheme-error ui-pnotify-shadow" role="alert" style="min-height: 16px;">
            ...
            <div class="ui-pnotify-action-bar" style="margin-top: 5px; clear: both; text-align: center; display: none;"></div>
        </div>
    </div>
<?php } ?>