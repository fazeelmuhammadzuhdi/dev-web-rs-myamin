...
<section id="page-title" style="padding: 2rem 0 !important; " class="bg-transparent">
    ...
    <div class="container clearfix ">
        <h1>PPID &raquo; <?= $alurPelayanan['title'] ?></h1>
            ...
            <div class="row gutter-40 col-mb-80">
                ...
                <div class="postcontent col-lg-9">
                    ...
                    <div id="posts" class="post-grid row grid-container gutter-30" data-layout="fitRows">
                        ...
                        <?php if (!empty($alurPelayanan)) : ?>
                            <div class="entry col-sm-12 col-12">
                                <div class="grid-inner">
                                    <div class="entry-image">
                                        <a href="<?= base_url('/frontend/images/ppid/' . $alurPelayanan['gambar']); ?>" data-lightbox="image"><img src="<?= base_url('/frontend/images/ppid/' . $alurPelayanan['gambar']); ?>" alt="Standard Post with Image"></a>
                                    </div>
