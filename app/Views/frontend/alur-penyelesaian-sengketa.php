                        ...
                        <div class="entry col-sm-12 col-12">
                            <div class="grid-inner">
                                <div class="entry-image">
                                    <a href="<?= base_url(); ?>/frontend/images/ppid/alur_penyelesaian_sengketa.jpg" data-lightbox="image"><img src="<?= base_url(); ?>/frontend/images/ppid/alur_penyelesaian_sengketa.jpg" alt="Standard Post with Image"></a>
                                </div>
