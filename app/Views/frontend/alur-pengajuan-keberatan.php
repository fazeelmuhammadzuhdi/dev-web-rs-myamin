                        ...
                        <div class="entry col-sm-12 col-12">
                            <div class="grid-inner">
                                <div class="entry-image">
                                    <a href="<?= base_url(); ?>/frontend/images/ppid/alur_permohonan_keberatan_informasi.jpg" data-lightbox="image"><img src="<?= base_url(); ?>/frontend/images/ppid/alur_permohonan_keberatan_informasi.jpg" alt="Standard Post with Image"></a>
                                </div>
