    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('penunjang/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="editor form-control <?= (session()->getFlashdata('error_keterangan')) ? 'is-invalid' : '' ?>" name="keterangan" placeholder="Inputkan Keterangan Penunjang"><?= old('keterangan') ?></textarea>
