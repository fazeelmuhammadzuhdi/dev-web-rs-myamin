...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('dokters/create') ?>" class="btn btn-primary">Add Dokter</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function hapus(id, nama) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Dokter Dengan Nama : ' + nama + ' Ini?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('dokters/delete/') ?>' + id,
                    dataType: 'json',
                    success: function(response) {
                        ...
                        if (response.sukses) {
                            Swal.fire({
                                ...
                                $('#tableDokter').DataTable().ajax.reload();
                            });
                        }
                    },
                    error: function(e) {
    ...
    function edit(id) {
        window.location = '<?= site_url('dokters/edit/') ?>' + id;
    }
</script>
