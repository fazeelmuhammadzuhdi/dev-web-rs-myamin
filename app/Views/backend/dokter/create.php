    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('dokters/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea class="form-control <?= (session()->getFlashdata('error_keterangan')) ? 'is-invalid' : '' ?>" name="keterangan" placeholder="Inputkan Keterangan Dokter"><?= old('keterangan') ?></textarea>
