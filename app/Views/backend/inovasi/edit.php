    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('inovasis/update'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>

                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="idinovasi" value="<?= $inovasi['idinovasi'] ?>">


                        <div class="form-row">
                            <div class="form-group col-md-8">
                                <label for="inputPassword4">Judul Inovasi</label>
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_judul')) ? 'is-invalid' : '' ?>" name="judul" autofocus value="<?= old('judul', $inovasi['judul']) ?>">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_tahun')) ? 'is-invalid' : '' ?>" name="tahun" value="<?= old('tahun', $inovasi['tahun']) ?>" placeholder="2025">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_jenis')) ? 'is-invalid' : '' ?>" name="jenis" value="<?= old('jenis', $inovasi['jenis']) ?>" placeholder="Contoh : Inovasi Pelayanan Publik">
                        ...
                        <div class="form-row mt-4 mb-3">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_tahapan')) ? 'is-invalid' : '' ?>" name="tahapan" autofocus value="<?= old('tahapan', $inovasi['tahapan']) ?>" placeholder="Implementasi">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_digital')) ? 'is-invalid' : '' ?>" name="digital" value="<?= old('digital', $inovasi['digital']) ?>" placeholder="Digital / Non Digital">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_inisiator')) ? 'is-invalid' : '' ?>" name="inisiator" value="<?= old('inisiator', $inovasi['inisiator']) ?>" placeholder="Contoh : Inovasi Pelayanan Publik">
                                <?= (session()->getFlashdata('error_inisiator')) ? "<div class='invalid-feedback'>" .
                                    session()->getFlashdata('error_inisiator') . "</div>" : ''; ?>
                            </div>
                            <div class="form-group col-md-2">
                                <label for="inputPassword4">Uji Coba Inovasi</label>
                                <input type="date" class="form-control <?= (session()->getFlashdata('error_ujicoba')) ? 'is-invalid' : '' ?>" name="ujicoba" value="<?= old('ujicoba', $inovasi['ujicoba']) ?>" placeholder="Contoh : Inovasi Pelayanan Publik">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="date" class="form-control <?= (session()->getFlashdata('error_implementasi')) ? 'is-invalid' : '' ?>" name="implementasi" value="<?= old('implementasi', $inovasi['implementasi']) ?>" placeholder="Contoh : Inovasi Pelayanan Publik">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_urusan')) ? 'is-invalid' : '' ?>" name="urusan" value="<?= old('urusan', $inovasi['urusan']) ?>" placeholder="Contoh : Inovasi Pelayanan Publik">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_panduan_teknis')) ? 'is-invalid' : '' ?>" name="panduan_teknis" autofocus><?= old('panduan_teknis', $inovasi['panduan_teknis']) ?></textarea>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_link_youtube')) ? 'is-invalid' : '' ?>" name="link_youtube" autofocus><?= old('link_youtube', $inovasi['link_youtube']) ?></textarea>
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_tujuan')) ? 'is-invalid' : '' ?>" name="tujuan" autofocus><?= old('tujuan', $inovasi['tujuan']) ?></textarea>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_manfaat')) ? 'is-invalid' : '' ?>" name="manfaat" autofocus><?= old('manfaat', $inovasi['manfaat']) ?></textarea>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_rancang')) ? 'is-invalid' : '' ?>" name="rancang" autofocus><?= old('rancang', $inovasi['rancang']) ?></textarea>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_hasil')) ? 'is-invalid' : '' ?>" name="hasil" autofocus><?= old('hasil', $inovasi['hasil']) ?></textarea>
