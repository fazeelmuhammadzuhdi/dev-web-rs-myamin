...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('sliders/create') ?>" class="btn btn-primary">Add Slider</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function hapus(id, judul) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Slider Dengan Judul : ' + judul + ' Ini?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('sliders/delete/') ?>' + id,
                    dataType: 'json',
    ...
    function edit(id) {
        window.location = '<?= site_url('sliders/edit/') ?>' + id;
    }
</script>
