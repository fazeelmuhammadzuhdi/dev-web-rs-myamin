...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Form Input Video</h4>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Form Input Video</h5>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('videos/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input id="tanggal" type="date" class="form-control <?= (session()->getFlashdata('error_tanggal')) ? 'is-invalid' : '' ?>" name="tanggal" value="<?= old('tanggal') ?>">
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= (session()->getFlashdata('error_status')) ? 'is-invalid' : '' ?>" required type="radio" name="status" id="inlineRadio1" value="PB" checked>
