...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('videos/create') ?>" class="btn btn-primary">Add Video</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function hapus(id, judul) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Data Video Dengan Judul : ' + judul + ' Ini?',
            icon: 'warning',
    ...
    function edit(id) {
        window.location = '<?= site_url('videos/edit/') ?>' + id;
    }
</script>
