    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('spesialis/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group">
                            <label for="inputAddress">Gelar Spesialis</label>
                            <input type="text" class="form-control <?= (session()->getFlashdata('error_gelar')) ? 'is-invalid' : '' ?>" name="gelar" placeholder="Contoh : Sp.A" autofocus value="<?= old('gelar') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Contoh : Spesialis Anak" class="form-control <?= (session()->getFlashdata('error_nama')) ? 'is-invalid' : '' ?>" name="nama" value="<?= old('nama') ?>">
