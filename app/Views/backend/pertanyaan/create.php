    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('faqs/save'); ?>" method="POST">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="editor form-control <?= (session()->getFlashdata('error_jawaban')) ? 'is-invalid' : '' ?>" name="jawaban" placeholder="Inputkan jawaban"><?= old('jawaban') ?></textarea>
