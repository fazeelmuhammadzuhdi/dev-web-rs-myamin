...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('faqs/create') ?>" class="btn btn-primary">Add <?= $title ?></a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function hapus(id, judul) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus FAQ Dengan Pertanyaan : ' + judul + ' Ini?',
            icon: 'warning',
    ...
    function edit(id) {
        window.location = '<?= site_url('faqs/edit/') ?>' + id;
    }
</script>
