        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Form Input Berita </h5>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('beritappid/save/' . $tipe); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="inputState" class="select2 form-control <?= (session()->getFlashdata('error_kategori_id')) ? 'is-invalid' : '' ?>" name="kategori_id">
                                    ...
                                    <?php foreach ($kategori as $item) {
                                        echo '<option value="' . $item['idkategori'] . '">' .  $item['title'] . '</option>';
                                    } ?>
                                </select>
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-2">
                                ...
                                <input type="datetime-local" class="form-control <?= (session()->getFlashdata('error_tanggal')) ? 'is-invalid' : '' ?>" name="tanggal" value="<?= old('tanggal') ?>">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <input placeholder="2014" type="text" class="form-control <?= (session()->getFlashdata('error_tahun')) ? 'is-invalid' : '' ?>" name="tahun" autofocus value="<?= old('tahun') ?>">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input placeholder="Selama Dibutuhkan" type="text" class="form-control <?= (session()->getFlashdata('error_jangka')) ? 'is-invalid' : '' ?>" name="jangka" autofocus value="<?= old('jangka') ?>">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input placeholder="Direktur RSUD PROF. H. Muhammad Yamin, S.H" type="text" class="form-control <?= (session()->getFlashdata('error_penanggung_jawab')) ? 'is-invalid' : '' ?>" name="penanggung_jawab" autofocus value="<?= old('penanggung_jawab') ?>">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input placeholder="RSUD PROF. H. Muhammad Yamin, S.H" type="text" class="form-control <?= (session()->getFlashdata('error_tempat')) ? 'is-invalid' : '' ?>" name="tempat" autofocus value="<?= old('tempat') ?>">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input placeholder="Masukkan Link" type="text" class="form-control <?= (session()->getFlashdata('error_link')) ? 'is-invalid' : '' ?>" name="link" autofocus value="<?= old('link') ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputState" class="form-control <?= (session()->getFlashdata('error_filetype')) ? 'is-invalid' : '' ?>" name="filetype">
                                    ...
                                    <option value="archive.png">Archive</option>
                                    <option value="docs.png">Docs</option>
                                    <option value="excel.png">Excel</option>
                                    <option value="image.png">Image</option>
                                    <option value="pdf.png">PDF</option>
                                    <option value="ppt.png">PPT</option>
                                    <option value="word.png">Word</option>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input <?= (session()->getFlashdata('error_status')) ? 'is-invalid' : '' ?>" type="radio" name="status" id="inlineRadio1" value="Y" checked>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input <?= (session()->getFlashdata('error_status')) ? 'is-invalid' : '' ?>" type="radio" name="status" id="inlineRadio2" value="T">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= (session()->getFlashdata('error_konten')) ? 'is-invalid' : '' ?>" id="summernote" name="konten" placeholder="Inputkan Konten Album"><?= old('konten') ?></textarea>
