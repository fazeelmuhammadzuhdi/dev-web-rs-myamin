...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('beritas/create') ?>" class="btn btn-primary">Add <?= $title ?></a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function hapus(id, judul) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('beritas/delete/') ?>' + id,
                    dataType: 'json',
    ...
    function edit(id) {
        window.location = '<?= site_url('beritas/edit/') ?>' + id;
    }
</script>
