    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('beritas/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="inputState" class="select2 form-control <?= (session()->getFlashdata('error_kategori_id')) ? 'is-invalid' : '' ?>" name="kategori_id">
                                ...
                                <?php foreach ($kategori as $item) {
                                    $selected = (old('kategori_id') == $item['idkategori']) ? 'selected' : '';
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input <?= (session()->getFlashdata('error_status')) ? 'is-invalid' : '' ?>" type="radio" name="status" id="inlineRadio1" value="PB" <?= (old('status') == 'PB') ? 'checked' : '' ?> checked>
                                    <label class="form-check-label" for="inlineRadio1">PB</label>
                                </div>
                                <?= (session()->getFlashdata('error_status')) ? "<div class='invalid-feedback'>" . session()->getFlashdata('error_status') . "</div>" : ''; ?>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input <?= (session()->getFlashdata('error_status')) ? 'is-invalid' : '' ?>" type="radio" name="status" id="inlineRadio2" value="UP" <?= (old('status') == 'UP') ? 'checked' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= (session()->getFlashdata('error_konten')) ? 'is-invalid' : '' ?>" id="konten" name="konten" placeholder="Inputkan Konten Album"><?= old('konten') ?></textarea>
