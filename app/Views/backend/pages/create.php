                ...
                <div class="card-body">
                    <form action="<?= base_url('page/save'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (session()->getFlashdata('error_title')) ? 'is-invalid' : '' ?>" name="title" value="<?= old('title') ?>" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= (session()->getFlashdata('error_konten')) ? 'is-invalid' : '' ?>" id="summernote" name="konten" placeholder="Inputkan konten Rawat"><?= old('konten') ?></textarea>
