...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('page/create') ?>" class="btn btn-primary">Add Pages</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function hapus(id, nama) {
        Swal.fire({
            title: 'Hapus Data Pages',
            text: 'Yakin Menghapus Pages Dengan Nama : ' + nama + ' Ini?',
            icon: 'warning',
    ...
    function edit(id) {
        window.location = '<?= site_url('page/edit/') ?>' + id;
    }
</script>
