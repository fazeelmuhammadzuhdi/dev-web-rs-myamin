...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('fasilitasumum/create') ?>" class="btn btn-primary">Add Fasilitas</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableFasilitas').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?= site_url('fasilitasumum/getData') ?>',
            order: [],
            columnDefs: [{
                targets: 0,
                orderable: false,
    ...
    function hapus(id, nama) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Fasilitas Dengan Nama : ' + nama + ' Ini?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('fasilitasumum/delete/') ?>' + id,
                    dataType: 'json',
    ...
    function edit(id) {
        window.location = '<?= site_url('fasilitasumum/edit/') ?>' + id;
    }
</script>
