...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('kategoris-ppid/create') ?>" class="btn btn-primary">Add Kategori</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableKategori').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?= site_url('kategoris-ppid/getData') ?>',
            order: [],
            columnDefs: [{
                targets: 0,
                orderable: false,
    ...
    function hapus(id, nama) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Kategori Dengan Nama : ' + nama + ' Ini?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('kategoris-ppid/delete/') ?>' + id,
                    dataType: 'json',
    ...
    function edit(id) {
        window.location = '<?= site_url('kategoris-ppid/edit/') ?>' + id;
    }
</script>
