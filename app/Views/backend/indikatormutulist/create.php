    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('indikatormutulists/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group">
                            ...
                            <select id="inputState" class="form-control <?= (session()->getFlashdata('error_indikator_mutu_id')) ? 'is-invalid' : '' ?>" name="indikator_mutu_id">
                                ...
                                <?php foreach ($indikatormutu as $item) {
                                    echo '<option value="' . $item['idindikatormutu'] . '">' .  $item['nama'] . '</option>';
                                } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= (session()->getFlashdata('error_keterangan')) ? 'is-invalid' : '' ?>" id="summernote" name="keterangan" placeholder="Inputkan Keterangan"><?= old('keterangan') ?></textarea>
