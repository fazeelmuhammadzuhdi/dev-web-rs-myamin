    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('indikatormutu/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>


                        <div class="form-group">
                            <label for="inputAddress">Nama Indikator Mutu</label>
                            <input type="text" placeholder="Contoh : Indikator Area Klinis" class="form-control <?= (session()->getFlashdata('error_nama')) ? 'is-invalid' : '' ?>" name="nama" autofocus value="<?= old('nama') ?>">
