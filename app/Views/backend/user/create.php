                ...
                <div class="card-body">
                    <form action="<?= base_url('users/save'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (session()->getFlashdata('error_username')) ? 'is-invalid' : '' ?>" name="username" autofocus value="<?= old('username') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (session()->getFlashdata('error_nama')) ? 'is-invalid' : '' ?>" name="nama" value="<?= old('nama') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control <?= (session()->getFlashdata('error_password')) ? 'is-invalid' : '' ?>" name="password" value="<?= old('password') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= (session()->getFlashdata('error_role')) ? 'is-invalid' : '' ?>" required type="radio" name="role" id="inlineRadio1" value="US" checked>
                                <label class="form-check-label" for="inlineRadio1">US</label> <br>

                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input <?= (session()->getFlashdata('error_role')) ? 'is-invalid' : '' ?>" required type="radio" name="role" id="inlineRadio2" value="SU">
