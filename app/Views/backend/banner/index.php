...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('banners/create') ?>" class="btn btn-primary">Add Banner</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">List Data <?= $title ?> Banner</h5>
                </div>
                <div class="card-body">
...
<script>
    ...
    function hapus(id, judul) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Banner Dengan Judul : ' + judul + ' Ini?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('banners/delete/') ?>' + id,
                    dataType: 'json',
    ...
    function edit(id) {
        window.location = '<?= site_url('banners/edit/') ?>' + id;
    }
</script>
