...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('kategoris/create') ?>" class="btn btn-primary">Add Kategori</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableKategori').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?= site_url('kategoris/getData') ?>',
            order: [],
            columnDefs: [{
                targets: 0,
                orderable: false,
    ...
    function hapus(id, nama) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('kategoris/delete/') ?>' + id,
                    dataType: 'json',
    ...
    function edit(id) {
        window.location = '<?= site_url('kategoris/edit/') ?>' + id;
    }
</script>
