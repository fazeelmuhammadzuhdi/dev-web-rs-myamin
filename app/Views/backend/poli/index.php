...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('poly/create') ?>" class="btn btn-primary">Add <?= $title ?></a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function hapus(id, nama) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Poli Dengan Nama : ' + nama + ' Ini?',
            icon: 'warning',
    ...
    function edit(id) {
        window.location = '<?= site_url('poly/edit/') ?>' + id;
    }
</script>
