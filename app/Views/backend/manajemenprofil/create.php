    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('manajemenprofils/save'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputState" class="select2 form-control <?= (session()->getFlashdata('error_manajemen_id')) ? 'is-invalid' : '' ?>" name="manajemen_id">
                                    ...
                                    <?php foreach ($manajemen as $item) {
                                        echo '<option value="' . $item['idmanajemen'] . '">' .  $item['nama'] . '</option>';
                                    } ?>
                                </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_jabatan')) ? 'is-invalid' : '' ?>" name="jabatan" value="<?= old('jabatan') ?>">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_nip')) ? 'is-invalid' : '' ?>" name="nip" autofocus value="<?= old('nip') ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_tempatlahir')) ? 'is-invalid' : '' ?>" name="tempatlahir" autofocus value="<?= old('tempatlahir') ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control <?= (session()->getFlashdata('error_tanggallahir')) ? 'is-invalid' : '' ?>" name="tanggallahir" value="<?= old('tanggallahir') ?>">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_pendidikan')) ? 'is-invalid' : '' ?>" name="pendidikan" autofocus value="<?= old('pendidikan') ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_pangkat')) ? 'is-invalid' : '' ?>" name="pangkat" autofocus value="<?= old('pangkat') ?>">
                            ...
                            <div class="form-group col-md-12">
                                <label for="inputAddress">Riwayat Pekerjaan</label>
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_profil_singkat')) ? 'is-invalid' : '' ?>" name="profil_singkat" autofocus><?= old('profil_singkat') ?></textarea>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control editor <?= (session()->getFlashdata('error_riwayat_pendidikan')) ? 'is-invalid' : '' ?>" name="riwayat_pendidikan" autofocus><?= old('riwayat_pendidikan') ?></textarea>
