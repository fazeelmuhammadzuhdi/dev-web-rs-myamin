    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('sejarahs/update'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>

                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="idsejarah" value="<?= $sejarahs['idsejarah'] ?>">


                        <div class="form-group">
                            <label for="inputAddress">Tahun Sejarah</label>
                            <input type="text" class="form-control <?= (session()->getFlashdata('error_tahun')) ? 'is-invalid' : '' ?>" name="tahun" autofocus value="<?= old('tahun', $sejarahs['tahun']) ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (session()->getFlashdata('error_judul')) ? 'is-invalid' : '' ?>" name="judul" autofocus value="<?= old('judul', $sejarahs['judul']) ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= (session()->getFlashdata('error_keterangan')) ? 'is-invalid' : '' ?>" name="keterangan" placeholder="Inputkan Keterangan Album"><?= old('keterangan', $sejarahs['keterangan']) ?></textarea>
