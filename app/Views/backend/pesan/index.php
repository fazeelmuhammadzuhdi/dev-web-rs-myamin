            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="tablePesan">
                            <thead>
                                <tr>
                                    <th scope="col">Id</th>
...
<script>
    ...
    function hapus(id, nama) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Pesan Dari : ' + nama + ' Ini?',
            icon: 'warning',
                    ...
                    success: function(response) {
                        ...
                        if (response.sukses) {
                            Swal.fire({
                                ...
                                $('#tablePesan').DataTable().ajax.reload();
                            });
                        }
                    },
                    error: function(e) {
    ...
    function edit(id) {
        window.location = '<?= site_url('pesans/edit/') ?>' + id;
    }
</script>
