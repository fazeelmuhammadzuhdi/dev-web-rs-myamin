    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="<?= base_url('referensis/update'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>

                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="idreferensi" value="<?= $referensi['idreferensi'] ?>">

                        <div class="form-row mb-3">

                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Judul</label>
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_judul')) ? 'is-invalid' : '' ?>" name="judul" autofocus value="<?= old('judul', $referensi['judul']) ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_pengarang')) ? 'is-invalid' : '' ?>" name="pengarang" value="<?= old('pengarang', $referensi['pengarang']) ?>">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_bahasa')) ? 'is-invalid' : '' ?>" name="bahasa" value="<?= old('bahasa', $referensi['bahasa']) ?>">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputState" class="form-control <?= (session()->getFlashdata('error_kategori')) ? 'is-invalid' : '' ?>" name="kategori">
                                    ...
                                    <option value="ap" <?= ($referensi['kategori'] == 'ap') ? 'selected' : '' ?>>AP</option>
                                    <option value="pdk" <?= ($referensi['kategori'] == 'pdk') ? 'selected' : '' ?>>PDK</option>
                                    <option value="plk" <?= ($referensi['kategori'] == 'plk') ? 'selected' : '' ?>>PLK</option>
                                    <option value="mnj" <?= ($referensi['kategori'] == 'mnj') ? 'selected' : '' ?>>MNJ</option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_penerbit')) ? 'is-invalid' : '' ?>" name="penerbit" value="<?= old('penerbit', $referensi['penerbit']) ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_tahun')) ? 'is-invalid' : '' ?>" name="tahun" value="<?= old('tahun', $referensi['tahun']) ?>">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('error_link')) ? 'is-invalid' : '' ?>" name="link" value="<?= old('link', $referensi['link']) ?>">
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control <?= (session()->getFlashdata('error_deskripsi')) ? 'is-invalid' : '' ?>" id="summernote" name="deskripsi" placeholder="Inputkan Deskripsi Referensi"><?= old('deskripsi', strip_tags($referensi['deskripsi'])) ?></textarea>
