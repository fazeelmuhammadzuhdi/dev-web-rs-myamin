...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('referensis/create') ?>" class="btn btn-primary">Add Referensi</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableReferensi').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?= site_url('referensis/getData') ?>',
            order: [],
            columnDefs: [{
                targets: 0,
                orderable: false,
    ...
    function hapus(id) {
        Swal.fire({
            ...
            text: 'Yakin Menghapus Data Referensi Dengan Id : ' + id + ' Ini?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'delete',
                    url: '<?= site_url('referensis/delete/') ?>' + id,
                    dataType: 'json',
    ...
    function edit(id) {
        window.location = '<?= site_url('referensis/edit/') ?>' + id;
    }
</script>
