        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Form Input Permohonan Informasi PPID</h5>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('pesanppid/update'); ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>

                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="idpesanppid" value="<?= $pesanppid['idpesanppid'] ?>">

                        <div class="form-row mb-3">

                            <div class="form-group col-md-4">
                                <label for="inputAddress">Nama Pemohon Informasi</label>
                                <input type="text" autofocus id="template-contactform-name" name="nama_pemohon_informasi" value="<?= old('nama_pemohon_informasi', $pesanppid['nama_pemohon_informasi']) ?>" class="form-control <?= (session()->getFlashdata('error_nama_pemohon_informasi')) ? 'is-invalid' : '' ?>" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="template-contactform-name" name="alamat_pemohon" value="<?= old('alamat_pemohon', $pesanppid['alamat_pemohon']) ?>" class="form-control <?= (session()->getFlashdata('error_alamat_pemohon')) ? 'is-invalid' : '' ?>" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" id="template-contactform-name" value="<?= old('nomor_telepon_pemohon', $pesanppid['nomor_telepon_pemohon']) ?>" name="nomor_telepon_pemohon" class="form-control <?= (session()->getFlashdata('error_nomor_telepon_pemohon')) ? 'is-invalid' : '' ?>" />
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-4">
                                ...
                                <input type="email" id="template-contactform-name" value="<?= old('email_pemohon', $pesanppid['email_pemohon']) ?>" name="email_pemohon" class="form-control <?= (session()->getFlashdata('error_email_pemohon')) ? 'is-invalid' : '' ?>" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea class="form-control <?= (session()->getFlashdata('error_informasi_dibutuhkan_pemohon')) ? 'is-invalid' : '' ?>" id="template-contactform-message" name="informasi_dibutuhkan_pemohon" rows="2" cols="30"><?= old('informasi_dibutuhkan_pemohon', $pesanppid['informasi_dibutuhkan_pemohon']) ?></textarea>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea class="form-control <?= (session()->getFlashdata('error_alasan_permintaan_pemohon')) ? 'is-invalid' : '' ?>" id="template-contactform-message" name="alasan_permintaan_pemohon" rows="2" cols="30"><?= old('alasan_permintaan_pemohon', $pesanppid['alasan_permintaan_pemohon']) ?></textarea>
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-4">
                                ...
                                <select id="template-contactform-service" name="cara_memperoleh_informasi" class="form-control valid">
                                    <!-- Selected -->
                                    <option value="Langsung" <?= ($pesanppid['cara_memperoleh_informasi'] == 'Langsung') ? 'selected' : '' ?>>Langsung</option>
                                    <option value="Website" <?= ($pesanppid['cara_memperoleh_informasi'] == 'Website') ? 'selected' : '' ?>>Website</option>
                                    <option value="Email" <?= ($pesanppid['cara_memperoleh_informasi'] == 'Email') ? 'selected' : '' ?>>Email</option>
                                    <option value="Fax" <?= ($pesanppid['cara_memperoleh_informasi'] == 'Fax') ? 'selected' : '' ?>>Fax</option>
                                    <option value="Via POS" <?= ($pesanppid['cara_memperoleh_informasi'] == 'Via POS') ? 'selected' : '' ?>>Via POS</option>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select id="template-contactform-service" name="format_bahan_informasi" class="form-control valid">
                                    <option value="Tercetak" <?= $pesanppid['format_bahan_informasi'] == 'Tercetak' ? 'Selected' : '' ?>>Tercetak</option>
                                    <option value="Terekam" <?= $pesanppid['format_bahan_informasi'] == 'Terekam' ? 'Selected' : '' ?>>Terekam</option>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
