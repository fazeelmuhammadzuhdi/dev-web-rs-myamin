...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= site_url('album/create') ?>" class="btn btn-primary">Add Album</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="tableAlbum">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
...
<script>
    ...
    function hapus(id, judul) {
        Swal.fire({
            title: 'Hapus Data Album',
            text: 'Yakin Menghapus Album Dengan Judul : ' + judul + ' Ini?',
            icon: 'warning',
    ...
    function edit(id) {
        window.location = '<?= site_url('album/edit/') ?>' + id;
    }
</script>
